        ...
        <Container className="space-y-10 max-w-4xl">
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-muted-foreground text-xs sm:text-sm">
              Last Updated: July 30, 2026 | Effective for all Jobora users across Kerala
            </p>
          </div>
          ...
          <Card className="p-6 sm:p-10 space-y-8 bg-orange-50/60 dark:bg-orange-950/20 border-orange-200/80 dark:border-orange-900/40">
            ...
            <section className="space-y-3">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Jobora (&ldquo;we&rdquo;, &ldquo;our&rdquo;, or &ldquo;us&rdquo;) operates the workforce marketplace connecting temporary event staff and verified event organizers across Kerala. We respect your privacy and are committed to protecting the personal data you share with us.
              </p>
            </section>
            ...
            <section className="space-y-3 border-t border-orange-200/60 dark:border-orange-900/30 pt-6">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                You have full control over your profile data. You may update your contact information, skill categories, or request account closure at any time by accessing your profile settings or contacting support@jobora.in.
              </p>
            </section>
            ...
            <section className="space-y-3 border-t border-orange-200/60 dark:border-orange-900/30 pt-6">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                If you have any questions or concerns regarding this Privacy Policy, please email our Data Officer at <strong>privacy@jobora.in</strong>.
              </p>
            </section>
          </Card>
        </Container>
